...
const foto = require("../assets/images/KAU.jpg")
    ...
    <View style={styles.container} >
      ...
      <View style = {styles.containerConteudo}>
        <View style = {styles.containerNome}>
          <Text style={styles.nome}>Kauany Vitória Taborda</Text>
        </View>
        ...
        <View style = {styles.containerDados}>
          ...
          <Text style = {styles.textoDados}>kauany.taborda@escola.pr.gov.br</Text>
        </View>
        <View style = {styles.containerDados}>
